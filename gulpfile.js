...
var paths = {
  src: {
    ...
    css: ['src/sass/core/*.scss', 'src/sass/**/*.scss', 'src/css/*.css'],
...
// Assembling .jslibs files
gulp.task('bundleJsLibs', function () {
...
gulp.task('watch', function () {
  ...
  gulp.watch(paths.src.libs, {cwd: './'}, ['bundleJsLibs']);
...
// General build task
gulp.task('build', ['bundleHtml', 'bundleCss', 'bundleJs', 'bundleJsLibs', 'bundleFonts', 'bundleImg']);
